CREATE DATABASE PID;
USE PID;
CREATE TABLE users (userID int NOT NULL PRIMARY KEY AUTO_INCREMENT,account varchar(30),password varchar(60),personID varchar(30),ban enum ('Y','N') DEFAULT 'N' NOT NULL);
CREATE TABLE userDetail(userID int NOT NULL ,account varchar(30),datatime timestamp  DEFAULT CURRENT_TIMESTAMP,actionName varchar(30),amount varchar(30),status varchar(30),sellerID int(10) NOT NULL,inventoryID int(10) NOT NULL);
...
CREATE TABLE inventory (inventory int NOT NULL PRIMARY KEY AUTO_INCREMENT, userID int NOT NULL ,commodityID int ZEROFILL NOT NULL ,quantity int(10),quantitySold int(10));
